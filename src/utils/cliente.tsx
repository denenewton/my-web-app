...
export const Axios = axios.create({
  baseURL: 'https://app-graphql.vercel.app/api',
  method: "post",
  headers: headers,
});

export const queryData = (QUERY:any, variables:any) => {
  return {
    query: QUERY,
    variables,
  };
...
export const GUET_MOVIES = `
query MyQuery($year: String = "", $title: String = "", $genre: String = "") {
  movies(filter: {genre: $genre, title: $title, year: $year}) {
    ... on Movie {
      id
      title
      release_date
